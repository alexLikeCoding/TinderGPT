...
with open(f'{current_dir}/prompts/writer_tindebielik.prompt', 'r', encoding='utf-8') as file:
    prompt_template = file.read()
...
Commander = create_llm(temperature=0.4)
Writer = create_llm(temperature=0.7)
